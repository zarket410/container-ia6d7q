...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ia6d7q.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ia6d7q.containers.anotherwebservice.com/
...
```
git clone git@github.com:zarket410/container-ia6d7q.git
cd container-ia6d7q
```
...
```
docker attach container-ia6d7q
```
